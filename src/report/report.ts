...
export const ReportProps: Record<keyof Report, estypes.MappingProperty> = {
    target: { type: "keyword" },
    dateStart: { type: "date" },
    dateEnd: { type: "date" },
    created: { type: "float" },
...
const ReportVersion = "jurisprudencia-indexer-report.3.0"
...
export const ConflictsProps: Record<JurisprudenciaDocumentExactKey | JurisprudenciaDocumentDateKey, estypes.MappingProperty> = {
    "Número de Processo": {
        properties: {
...
const ConflictsVersion = "jurisprudencia-indexer-conflicts.3.0"
